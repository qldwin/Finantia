<template>
  <div class="py-12">
    <div class="max-w-3xl mx-auto">
      <h1 class="text-4xl font-bold mb-6 text-neutral-900 dark:text-neutral-50">À propos de Finantia</h1>
      
      <div class="card mb-8">
        <h2 class="text-2xl font-semibold mb-4 text-neutral-900 dark:text-neutral-50">Notre mission</h2>
        <p class="text-neutral-700 dark:text-neutral-300 mb-4">
          Finantia est née d'une vision simple : rendre la gestion financière accessible à tous. Notre mission est de vous offrir les outils et les connaissances nécessaires pour prendre le contrôle de vos finances, que vous soyez débutant ou expert.
        </p>

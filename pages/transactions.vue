          ...
          <table class="w-full">
            <thead>
              <tr class="border-b border-neutral-200 dark:border-neutral-800">
                ...
                <th class="text-left py-2 px-4 text-neutral-700 dark:text-neutral-300 text-sm font-medium">Description</th>
            ...
            <tbody>
              <tr v-for="transaction in transactions" :key="transaction.id" class="border-b border-neutral-200 dark:border-neutral-800">
                <td class="py-3 px-4 text-sm text-neutral-600 dark:text-neutral-400">{{ formatDate(transaction.date) }}</td>
                ...
                <td class="py-3 px-4 text-sm text-right font-medium" :class="transaction.type === 'income' ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'">
                  {{ transaction.type === 'income' ? '+' : '-' }} {{ formatCurrency(transaction.amount) }}
                </td>
                <td class="py-3 px-4 text-right">
                  <button @click="editTransaction(transaction)" class="text-neutral-500 hover:text-primary-600 dark:hover:text-primary-400 mr-2">
